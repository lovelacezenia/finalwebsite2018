...
<head>
    ...
    <title>IT 324 | Web Systems and Technologies</title>
...
<body>
    ...
    <div id="page-wrap">
        ...
        <form action="score2.php" method="post" id="quiz">
            ...
            <ol>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-2-answers-A">A) Context Scope </label>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="question-2-answers-C">C) Session Scope </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-4-answers-B">B) Initialization </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-C" value="C" required/>
                        <label for="question-4-answers-C">C) Request Handling </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-D" value="D" required/>
                        <label for="question-4-answers-D">D) Invoke Service() method </label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-9-answers-A">A) Personal Home Page </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-B" value="B" required/>
                        <label for="question-9-answers-B">B) Hypertext Preprocessor </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-C" value="C" required/>
                        <label for="question-9-answers-C">C)  Pretext Hypertext Processor </label>
                    </div>
